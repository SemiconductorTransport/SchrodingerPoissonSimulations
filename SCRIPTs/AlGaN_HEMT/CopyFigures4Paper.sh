...
# Figure S4a
cp ${FigsOriginFolderMobility}/Individual/Barrier_5.00_2DEG.eps ${FigsEndFolder}/Figure_S4a.eps
# Figure S4b
cp ${FigsOriginFolderMobility}/Individual/Barrier_15.00_2DEG.eps ${FigsEndFolder}/Figure_S4b.eps
# Figure S4c
cp ${FigsOriginFolderMobility}/Individual/Barrier_30.00_2DEG.eps ${FigsEndFolder}/Figure_S4c.eps
# Figure S4d
cp ${FigsOriginFolderMobility}/Individual/Barrier_50.00_2DEG.eps ${FigsEndFolder}/Figure_S4d.eps
# Figure S5a
cp ${FigsOriginFolderMobility}/Individual/Barrier_5.00_2DHG.eps ${FigsEndFolder}/Figure_S5a.eps
# Figure S5b
cp ${FigsOriginFolderMobility}/Individual/Barrier_50.00_2DHG.eps ${FigsEndFolder}/Figure_S5b.eps
# Figure S6a
cp ${FigsOriginFolderDensity}/sim_sweep__ThicknessAlGaNBarrier/2DEHG_device.eps ${FigsEndFolder}/Figure_S6a.eps
# Figure S6b
cp ${FigsOriginFolderDensity}/sim_sweep__ThicknessAlGaNChannel/2DEHG_device.eps ${FigsEndFolder}/Figure_S6b.eps
# Figure S7a
cp ${FigsOriginFolderMobility}/Others/two_deg_Tb_AlN_Al0.50GaN.eps ${FigsEndFolder}/Figure_S7a.eps
# Figure S7b
cp ${FigsOriginFolderDensity}/Al85_C_sweep__ThicknessAlGaNBarrier/2DEG_device.eps ${FigsEndFolder}/Figure_S7b.eps
# Figure S8
